-- Sort the data in all columns in the film table provided that the replacement_cost value is greater than 12.99, equal and less than 16.99 (use BETWEEN - AND structure).
...
SELECT fisrt_name, last_name FROM actor
